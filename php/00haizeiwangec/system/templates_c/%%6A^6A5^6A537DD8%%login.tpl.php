<?php /* Smarty version 2.6.28, created on 2014-12-27 03:18:42
         compiled from login.tpl */ ?>
﻿<?php if ($this->_tpl_vars['member'] == "游客"): ?>
...
<form id="login" name="login" method="post" action="#" onsubmit="return lg(this)">
  ...
  <tr>
    <td height="25" colspan="3" align="center"><input id="enter" name="enter" type="submit" value="登陆"></td>
  </tr>
  <tr>
