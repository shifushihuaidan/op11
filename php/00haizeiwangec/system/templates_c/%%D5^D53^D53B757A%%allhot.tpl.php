<?php /* Smarty version 2.6.28, created on 2014-12-25 06:44:04
...
" style="border: 1px solid #f0f0f0;" /></td>
            <td height="35">商品名称：<?php echo $this->_tpl_vars['hotarr'][$this->_sections['hot_id']['index']]['name']; ?>
</td>
            <td width="156" height="35">商品类别：<?php echo $this->_tpl_vars['hotarr'][$this->_sections['hot_id']['index']]['class']; ?>
</td>
            <td width="157">商品型号：<?php echo $this->_tpl_vars['hotarr'][$this->_sections['hot_id']['index']]['model']; ?>
</td>
          </tr>
          <tr>
