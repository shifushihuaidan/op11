<table id="__01" width="207" height="73" border="1" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="207" height="211" border="0" cellpadding="0" cellspacing="0" background="images/shop_13.gif" id="__01">
  ...
  <tr>
	...
	{section name=id loop=$linarr}
    <a href="{$linarr[id].url}" target="_blank" class="lk">{$linarr[id].name}</a><br />
    {/section}    </td>
	<td></td>
  </tr>
</table>
