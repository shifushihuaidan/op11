...
{section name=mem_id loop=$memarr}
  <tr>
   ...
   <input id="free" name="free" type="button" class="btn" value = "{if $memarr[mem_id].isfreeze == 0}未冻结 {elseif $memarr[mem_id].isfreeze == 1}冻结{/if}" style="border-color: #FFFFFF;" onClick="return changestate({ $memarr[mem_id].id},{ $memarr[mem_id].isfreeze})">    </td>
