<?php /* Smarty version 2.6.28, created on 2014-12-25 06:37:39
...
?>
  <tr>
    <td height="25" align="center" valign="middle" class="left">
    	<input id="chk" name="chk[]" type="checkbox" value="<?php echo $this->_tpl_vars['memarr'][$this->_sections['mem_id']['index']]['id']; ?>
"></td>
...
<?php endfor; endif; ?> 
  ...
  <tr>
    <td colspan="5"><?php echo $this->_tpl_vars['rst1_page']; ?>
</td>
  </tr>
</form>
</table>
