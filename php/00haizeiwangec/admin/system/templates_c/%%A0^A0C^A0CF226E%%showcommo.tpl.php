<?php /* Smarty version 2.6.28, created on 2014-12-25 06:37:26
...
?>
  <tr>
    <!--<td height="25" align="center" valign="middle" class="left">
    	<input name="chk[]" type="checkbox" id="chk" value="<?php echo $this->_tpl_vars['commoarr'][$this->_sections['com_id']['index']]['id']; ?>
"></td>-->
    <td height="25" align="center" valign="middle" class="left">&nbsp;<?php echo $this->_tpl_vars['commoarr'][$this->_sections['com_id']['index']]['id']; ?>
</td>
...
" type='button' value="更改" class="btn" style=" border-color: #FFFFFF; cursor: ahnd;" onclick="modi(<?php echo $this->_tpl_vars['commoarr'][$this->_sections['com_id']['index']]['id']; ?>
	...
	<td height="25" align="center" valign="middle" class="right"><input id="deletedata" name="mod<?php echo $this->_tpl_vars['commoarr'][$this->_sections['com_id']['index']]['name']; ?>
" type='button' value="删除" class="btn" style=" border-color: #FFFFFF; cursor: ahnd;" onclick="del(delcomm,<?php echo $this->_tpl_vars['commoarr'][$this->_sections['com_id']['index']]['id']; ?>
)"/></td>
  </tr>
<?php endfor; endif; ?> 
  <tr>
...
<tr>
    <td colspan="10"><?php echo $this->_tpl_vars['rst1_page']; ?>
</td>
  </tr>
</table>
<div id="content"></div>
