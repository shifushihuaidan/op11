<?php /* Smarty version 2.6.28, created on 2014-12-25 11:20:57
...
"></td>
    <td align="center" valign="middle" class="center"><input id="wnames" name="wnames<?php echo $this->_tpl_vars['linkarr'][$this->_sections['link_id']['index']]['id']; ?>
" type="text" class="txt" value="<?php echo $this->_tpl_vars['linkarr'][$this->_sections['link_id']['index']]['name']; ?>
" /></td>
    <td align="center" valign="middle" class="center"><input id="wurl" name="wurl<?php echo $this->_tpl_vars['linkarr'][$this->_sections['link_id']['index']]['id']; ?>
